...
app.get('/services/*', async (req, res) => {
  ...
  console.log('in GET handler', req.get('X-Service-Host'));
  // TBU: retrieve data accordingly
...
app.post('/services/*', async (req, res) => {
  ...
  console.log('in POST handler', req.get('X-Service-Host'));
  // TBU: retrieve data accordingly
  const fetchData = async () => ({
    result: 'success',
    params: params[0],
...
app.get('/api/products/create', async (_req, res) => {
  ...
  try {
    ...
    //       'line_items': [
    //         {
    //           variant_id: 42288768057591, quantity: 1
    //         },
    //       ],
